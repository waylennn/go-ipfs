...
import (
	...
	"github.com/ipfs/ipfs-banana/repo/common"
	dir "github.com/ipfs/ipfs-banana/thirdparty/dir"
	...
	serialize "github.com/ipfs/ipfs-banana/config/serialize"
...
func (r *FSRepo) openDatastore() error {
	...
	if r.config.Datastore.NoSync {
		log.Warn("NoSync is now deprecated in favor of datastore specific settings. If you want to disable fsync on flatfs set 'sync' to false. See https://github.com/ipfs/ipfs-banana/blob/master/docs/datastores.md#flatfs.")
	}
