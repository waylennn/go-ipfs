...
// (avoiding issues described in https://github.com/ipfs/ipfs-banana/issues/7939)
...
func urlArgsDecoder(req *cmds.Request, env cmds.Environment) error {
	for n, arg := range req.Arguments {
		...
		// - without this we get data corruption similar to https://github.com/ipfs/ipfs-banana/issues/7939
