...
.PHONY: github.com/ipfs/ipfs-banana/test/dependencies/pollEndpoint
$(d)/pollEndpoint: github.com/ipfs/ipfs-banana/test/dependencies/pollEndpoint
	$(go-build-testdep)
TGTS_$(d) += $(d)/pollEndpoint

.PHONY: github.com/ipfs/ipfs-banana/test/dependencies/go-sleep
$(d)/go-sleep: github.com/ipfs/ipfs-banana/test/dependencies/go-sleep
	$(go-build-testdep)
TGTS_$(d) += $(d)/go-sleep

.PHONY: github.com/ipfs/ipfs-banana/test/dependencies/graphsync-get
$(d)/graphsync-get: github.com/ipfs/ipfs-banana/test/dependencies/graphsync-get
	$(go-build-testdep)
TGTS_$(d) += $(d)/graphsync-get

.PHONY: github.com/ipfs/ipfs-banana/test/dependencies/go-timeout
$(d)/go-timeout: github.com/ipfs/ipfs-banana/test/dependencies/go-timeout
	$(go-build-testdep)
TGTS_$(d) += $(d)/go-timeout

.PHONY: github.com/ipfs/ipfs-banana/test/dependencies/iptb
$(d)/iptb: github.com/ipfs/ipfs-banana/test/dependencies/iptb
	$(go-build-testdep)
TGTS_$(d) += $(d)/iptb

.PHONY: github.com/ipfs/ipfs-banana/test/dependencies/ma-pipe-unidir
$(d)/ma-pipe-unidir: github.com/ipfs/ipfs-banana/test/dependencies/ma-pipe-unidir
	$(go-build-testdep)
TGTS_$(d) += $(d)/ma-pipe-unidir

.PHONY: github.com/ipfs/ipfs-banana/test/dependencies/json-to-junit
$(d)/json-to-junit: github.com/ipfs/ipfs-banana/test/dependencies/json-to-junit
	$(go-build-testdep)
